...
export const Bio = {
    ...
    description:
      " Hello 👋🏼, I am Hisana,an AI Full Stack Developer, based in Canada, I particularly enjoy building AI-based applications and integrating intelligent APIs to craft smarter, 
                        more responsive user experiences. 
                        I’m an innovative and future-focused Software Engineer with a deep passion for AI-powered applications and Machine Learning. 
                        If you have an opportunity, feel free to contact me.
                        I am driven by the goal of using tech to make a real difference. My broader vision is to build with purpose — leveraging technology to create meaningful, human-centered impact.Let’s connect if you’re working on impactful tech who combines strong technical skills with a mission-driven mindset.",
  ...
  export const certifications = [
    ...
    
    {
      id: 3,
      img: tesz,
      role: "Growth lead- Business Development",
      company: "Tesz.in",
  ...
  export const education = [
    ...
    },
    {
      id: 1,
      img: tkm,
      school: "TKM College of Engineering",
      date: "August 2015 - Apr 2019",
      grade: "7.64",
      desc: "I have done my bachelor's in Civil Engineering from TKM College of Engineering, India",
  ...
  export const projects = [
    ...
    },
    {
      ...
      date: "Feb 2023",
      description:
        "The platform features a user-friendly interface allowing pet owners to find suitable matches for their dogs",
      image:pp,
      tags: [
        "HTML",
        "CSS",
    ...
    {
      id: 2,
      title: "Graph Based Virtual Screening",
