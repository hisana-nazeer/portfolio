...
export const Bio = {
    ...
    description:
      " Hello 👋🏼, I am Hisana,an AI Full Stack Developer, based in Canada, I enjoy building AI-based applications and integrating intelligent APIs to craft smarter, more responsive user experiences. I’m an innovative and future-focused Software Engineer with a deep passion for AI-powered applications and Machine Learning. I am driven by the goal of using tech to make a real difference. My broader vision is to build with purpose — leveraging technology to create meaningful, human-centered impact.Let’s connect if you’re working on impactful tech who combines strong technical skills with a mission-driven mindset.",
