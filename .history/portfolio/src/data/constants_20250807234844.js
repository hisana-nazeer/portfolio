...
export const Bio = {
    ...
    description:
      " A passionate Software Engineer with a recent Master's in Computer Science and AWS Certified Cloud Practitioner. Specializing in Web Development and Machine Learning, I'm committed to innovation and lifelong learning, as evidenced by my IEEE publication. Eager to make impactful contributions to the tech industry, I welcome you to my portfolio, where my enthusiasm, hard work, and dedication are vividly showcased.",
