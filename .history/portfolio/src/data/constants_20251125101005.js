...
export const Bio = {
  ...
  export const projects = [
  {
      ...
      description: "Value+ Ed is An app that reads a user’s PDF résumé, analyzes it with AI, and instantly delivers their estimated hire value along with strengths and improvement insights
 ,       
         image:MamaBloom,
      tags: [
